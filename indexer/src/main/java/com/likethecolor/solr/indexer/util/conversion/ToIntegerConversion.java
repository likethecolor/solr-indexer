...
public class ToIntegerConversion {
  private String valueToBeConverted;

  public ToIntegerConversion(String valueToBeConverted) {
  ...
  public Integer getIntegerValue(final Integer defaultValue) {
    Integer integerValue = defaultValue;
    if(valueToBeConverted != null && valueToBeConverted.trim().length() > 0) {
      try {
        integerValue = Integer.parseInt(valueToBeConverted.trim());
      }
