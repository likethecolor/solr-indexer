...
public class DynamicClassException extends RuntimeException {
  ...
  public DynamicClassException(String className) {
  ...
  public DynamicClassException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
